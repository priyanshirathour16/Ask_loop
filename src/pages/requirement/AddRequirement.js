...
export default function AddRequirement({ onClose, after, tags }) {
    ...
    >
      ...
      >
        <div className="flex items-center justify-between px-4 py-3 bg-[#224d68] text-white">
          <h2 className="text-[16px] font-semibold">Add Service</h2>
          <button
        ...
        <form className="p-4 space-y-4">
         ...
         active:border-blue-600"
          ...
          <div className="flex justify-end">
            ...
            >
              {loading ? "Adding..." : "Add Service"}<ChevronsRightIcon size={11} className="" />
            </button>
          </div>
        </form>
      </motion.div>
