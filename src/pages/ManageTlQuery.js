  ...
  return (
    ...
    >
        ...
        <div className="bg-blue-400 text-white py-3 mb-3">
          <div className="container flex items-center justify-between p-0">
            ...
            <div className="flex items-center justify-between space-x-2">
              ...
              <button
                disabled={loopuserObject.tl == 1 && loopuserObject.tl_type == 2}
                onClick={toggleUsersDiv}
                className="flex items-center mr-3 rounded px-2 py-1 f-14 btn-light"
              >
        ...
        <div className="flex items-end space-x-2 px-3">
          <div className="row">
            ...
            <div
              ...
              style={{
                display:
                  currentTlEmail == "balakumar.v@dissertationindia.net" ||
                  currentTlEmail == "rc.tech.3@dissertationindia.net"
                    ? "none"
                    : "",
              }}
            >
            ...
            <div className="col flex items-center justify-end">
              ...
              <div className="flex">
                <button
                  className="bg-gray-200 text-gray-500  hover:bg-gray-300  f-12 btn px-2 py-1 mr-2"
      ...
      <AnimatePresence>
        ...
        {selectuserDiv && <SelectUsers onClose={toggleUsersDiv} />}
