    ...
    <div>
      ...
      <div className="flex items-center justify-between gap-2 bg-white p-3 rounded">
        ...
        <div className="flex items-center gap-2">
          ...
          {(loopUserObject.fld_admin_type === "SUPERADMIN" || loopUserObject.fld_admin_type === "SUBADMIN") && (
            <button
      ...
      {/* Actions */}
      <div className="bg-white mx-auto  max-w-xl p-3 f-13 mt-4">
        ...
        {loading ? (
          ...
          <div className="overflow-x-auto ">
            <div className="flex items-center justify-end gap-2 bg-white pb-3 rounded ">
              <SearchBar
                value={searchTerm}
